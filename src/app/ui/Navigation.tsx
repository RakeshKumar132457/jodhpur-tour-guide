...
import { navigationMenu } from "../contents/siteContent";
                ...
                <div className="container px-4 mx-auto">
                    <div className="flex justify-between items-center">
                                ...
                                {navigationMenu.map((item) => {
                                    return (
                                        <li key={item.id} className="">
                                            <Link
                                                href={item.href}
                                                className="transition duration-300 ease-in-out border-0 hover:border-b hover:border-100 hover:border-black"
                                            >
                                                {" "}
                                                {item.label}{" "}
                                            </Link>
                        ...
                        <div>
                            <Link
                                href="#"
                                className="px-5 py-4 bg-primary text-white rounded-lg hidden lg:inline-block hover:bg-secondary"
                            >
                                Book Now
                            </Link>
